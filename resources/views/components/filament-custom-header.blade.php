...
<header class="flex h-16 w-full shrink-0 items-center justify-between gap-4 border-b border-gray-200/50 dark:border-white/10 px-6 transition-all backdrop-blur-md rounded-t-xl">
    <div class="flex items-center gap-2 overflow-hidden">
        ...
        <button 
            ...
            class="inline-flex items-center justify-center rounded-md size-8 text-gray-500 hover:bg-gray-100 dark:hover:bg-white/5 transition-colors"
        >
    ...
    <div class="flex items-center gap-3">
        {{-- Actions --}}
        @if (is_array($headerActions) && count($headerActions))
        ...
        {{-- Dodatkowy przycisk (np. Feedback/Support) --}}
